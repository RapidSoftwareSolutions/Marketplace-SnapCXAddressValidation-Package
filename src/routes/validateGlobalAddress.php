<?php
$app->post('/api/SnapCXAddressValidation/validateGlobalAddress', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'requestId', 'street', 'country']);
    ...
    $query_str = $settings['api_url'] . "validateGlobalAddress";
    $body = array();
